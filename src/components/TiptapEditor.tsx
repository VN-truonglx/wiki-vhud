...
const TiptapEditor = ({ onChange, initialContent }: TiptapProps) => {
    ...
    const editor = useEditor({
        // Tiptap v3: mặc định không re-render component khi có transaction (đổi selection/mark)
        // nên các nút toolbar (Bold/Italic/Underline...) không tự cập nhật trạng thái active nếu thiếu dòng này
    ...
    return (
        <div className={`w-full border rounded-2xl overflow-hidden transition-all duration-500 shadow-2xl ${isDarkMode ? "bg-slate-900 border-slate-700 text-white" : "bg-white border-slate-200 text-slate-900"}`}>
            ...
            <div className={`sticky top-0 z-50 flex items-center gap-0.5 p-1.5 border-b transition-colors ${isDarkMode ? "bg-slate-800/50 border-slate-700" : "bg-slate-50 border-slate-100"}`}>
                ...
                <button
                    ...
                    className={`p-2 rounded-lg ${editor.isActive("bold") ? "bg-orange-500 text-white shadow-md" : "hover:bg-orange-100"}`}
                >
                    <Bold size={18} />
                </button>
                ...
                <button
                    ...
                    className={`p-2 rounded-lg ${editor.isActive("italic") ? "bg-orange-500 text-white shadow-md" : "hover:bg-orange-100"}`}
                >
                    <Italic size={18} />
                </button>
                ...
                <button
                    ...
                    className={`p-2 rounded-lg ${editor.isActive("underline") ? "bg-orange-500 text-white shadow-md" : "hover:bg-orange-100"}`}
                >
                ...
                <button
                    ...
                    className={`p-2 rounded-lg ${editor.isActive("strike") ? "bg-orange-500 text-white shadow-md" : "hover:bg-orange-100"}`}
                >
                ...
                <button
                    ...
                    className={`p-2 rounded-lg ${editor.isActive("highlight") ? "bg-yellow-400 text-black shadow-md" : "hover:bg-orange-100"}`}
                >
                    <Highlighter size={18} />
                </button>
                ...
                <div className="relative">
                    ...
                    {showColorPicker && (
                        <>
                            ...
                            <div className={`absolute z-50 top-full mt-2 left-0 w-44 grid grid-cols-5 gap-1.5 p-2 rounded-xl border shadow-xl ${isDarkMode ? "bg-slate-800 border-slate-700" : "bg-white border-slate-200"}`}>
                                ...
                                <div className={`col-span-5 mt-1 pt-1.5 flex items-center gap-2 border-t ${isDarkMode ? "border-slate-700" : "border-slate-100"}`}>
                                    <label
                                        className="relative w-6 h-6 shrink-0 rounded-full border border-slate-200 overflow-hidden cursor-pointer hover:scale-110 transition-transform"
                                    ...
                                    <button
                                        ...
                                        className={`text-xs font-semibold ${isDarkMode ? "text-slate-300 hover:text-white" : "text-slate-500 hover:text-slate-800"}`}
                                    >
                                        Xoá màu
                                    </button>
                                </div>
