...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`w-full z-40 bg-white/10 border-b backdrop-blur-md transition-all ${
          ...
          <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              {isLoggedIn ? (
                ...
                <Menu
                  as="div"
                  className="relative inline-block text-left border-l pl-3 border-slate-200"
                >
